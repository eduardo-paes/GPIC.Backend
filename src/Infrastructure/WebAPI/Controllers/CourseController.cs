...
namespace WebAPI.Controllers
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        public async Task<ActionResult<DetailedReadCourseResponse>> Create([FromBody] CreateCourseRequest request)
        {
            try
            {
                DetailedReadCourseResponse? model = await _service.Create(request) as DetailedReadCourseResponse;
        ...
        public async Task<ActionResult<DetailedReadCourseResponse>> Update(Guid? id, [FromBody] UpdateCourseRequest request)
        {
            try
            {
                DetailedReadCourseResponse? model = await _service.Update(id, request) as DetailedReadCourseResponse;
        ...
        public async Task<ActionResult<DetailedReadCourseResponse>> Delete(Guid? id)
        {
            ...
            try
            {
                DetailedReadCourseResponse? model = await _service.Delete(id.Value) as DetailedReadCourseResponse;
