...
namespace WebAPI.Controllers
{
    ...
    public class NoticeController : ControllerBase
    {
        ...
        public async Task<ActionResult<DetailedReadNoticeResponse>> Create([FromForm] CreateNoticeRequest request)
        {
            try
            {
                DetailedReadNoticeResponse? model = await _service.Create(request) as DetailedReadNoticeResponse;
        ...
        public async Task<ActionResult<DetailedReadNoticeResponse>> Update(Guid? id, [FromForm] UpdateNoticeRequest request)
        {
            try
            {
                DetailedReadNoticeResponse? model = await _service.Update(id, request) as DetailedReadNoticeResponse;
        ...
        public async Task<ActionResult<DetailedReadNoticeResponse>> Delete(Guid? id)
        {
            ...
            try
            {
                DetailedReadNoticeResponse? model = await _service.Delete(id.Value) as DetailedReadNoticeResponse;
