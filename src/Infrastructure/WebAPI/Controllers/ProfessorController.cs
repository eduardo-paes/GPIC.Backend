...
namespace WebAPI.Controllers
{
    ...
    public class ProfessorController : ControllerBase
    {
        ...
        public async Task<ActionResult<DetailedReadProfessorResponse>> Create([FromBody] CreateProfessorRequest request)
        {
            try
            {
                DetailedReadProfessorResponse? model = await _service.Create(request) as DetailedReadProfessorResponse;
        ...
        public async Task<ActionResult<DetailedReadProfessorResponse>> Update(Guid? id, [FromBody] UpdateProfessorRequest request)
        {
            try
            {
                DetailedReadProfessorResponse? model = await _service.Update(id, request) as DetailedReadProfessorResponse;
        ...
        public async Task<ActionResult<DetailedReadProfessorResponse>> Delete(Guid? id)
        {
            ...
            try
            {
                DetailedReadProfessorResponse? model = await _service.Delete(id.Value) as DetailedReadProfessorResponse;
