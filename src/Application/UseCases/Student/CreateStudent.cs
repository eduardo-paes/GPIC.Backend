...
namespace Application.UseCases.Student
{
    public class CreateStudent : ICreateStudent
    {
        ...
        public async Task<DetailedReadStudentOutput> ExecuteAsync(CreateStudentInput model)
        {
            ...
            // var entity = _mapper.Map<Domain.Entities.Student>(input);
            Domain.Entities.Student? entity = new(model.BirthDate,
                model.RG,
                model.IssuingAgency,
                model.DispatchDate,
            ...
            Domain.Entities.User? user = await _userRepository.GetUserByEmailAsync(model.Email);
            ...
            Domain.Entities.Course? course = await _courseRepository.GetByIdAsync(model.CourseId);
            ...
            Domain.Entities.Campus? campus = await _campusRepository.GetByIdAsync(model.CampusId);
            ...
            // Cria usuário
            user = new Domain.Entities.User(model.Name, model.Email, model.Password, model.CPF, ERole.STUDENT);
