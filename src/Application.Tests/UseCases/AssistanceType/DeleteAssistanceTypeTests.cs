...
{
    public class DeleteAssistanceTypeTests
    {
        private readonly Mock<IAssistanceTypeRepository> _repositoryMock = new();
        private readonly Mock<IMapper> _mapperMock = new();

        private IDeleteAssistanceType CreateUseCase() => new DeleteAssistanceType(_repositoryMock.Object, _mapperMock.Object);
        ...
        public async Task ExecuteAsync_ValidInput_ReturnsDetailedReadAssistanceTypeOutput()
        {
            ...
            _repositoryMock.Setup(repo => repo.DeleteAsync(id)).ReturnsAsync(assistanceType);
