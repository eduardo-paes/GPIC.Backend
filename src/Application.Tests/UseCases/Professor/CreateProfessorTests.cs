...
namespace Application.Tests.UseCases.Professor
{
    public class CreateProfessorTests
    {
        ...
        public async Task ExecuteAsync_ValidInput_ReturnsDetailedReadProfessorOutput()
        {
            ...
            _userRepositoryMock.Setup(userRepository => userRepository.GetUserByCPFAsync(input.CPF)).ReturnsAsync((User)null);
            _userRepositoryMock.Setup(userRepository => userRepository.CreateAsync(It.IsAny<User>())).ReturnsAsync(user);
            ...
            _userRepositoryMock.Verify(userRepository => userRepository.CreateAsync(It.IsAny<User>()), Times.Once);
        ...
        public void ExecuteAsync_PasswordIsNull_ThrowsUseCaseException()
        {
            ...
            _userRepositoryMock.Verify(userRepository => userRepository.CreateAsync(It.IsAny<User>()), Times.Never);
