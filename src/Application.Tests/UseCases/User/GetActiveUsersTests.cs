...
namespace Application.Tests.UseCases.User
{
    public class GetActiveUsersTests
    {
        ...
        private IGetActiveUsers CreateUseCase() => new GetActiveUsers(_repositoryMock.Object, _mapperMock.Object);
        ...
        public async Task ExecuteAsync_ValidInput_ReturnsListOfUserReadOutput()
        {
            ...
            _repositoryMock.Setup(repo => repo.GetActiveUsersAsync(skip, take)).ReturnsAsync(users);
            ...
            _repositoryMock.Verify(repo => repo.GetActiveUsersAsync(skip, take), Times.Once);
        ...
        public void ExecuteAsync_InvalidSkipAndTake_ThrowsArgumentException()
        {
            ...
            _repositoryMock.Verify(repo => repo.GetActiveUsersAsync(It.IsAny<int>(), It.IsAny<int>()), Times.Never);
