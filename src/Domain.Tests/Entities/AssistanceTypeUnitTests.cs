...
{
    public class AssistanceTypeUnitTests
    {
        private AssistanceType MockValidAssistanceType() =>
            new AssistanceType(Guid.NewGuid(), "Scholarship Name", "Scholarship Description");

        [Fact]
        public void SetName_ValidName_SetsName()
        {
            // Arrange
            var scholarship = MockValidAssistanceType();
