...
{
    public class TypeAssistanceUnitTests
    {
        private TypeAssistance MockValidTypeAssistance() =>
            new TypeAssistance(Guid.NewGuid(), "Scholarship Name", "Scholarship Description");

        [Fact]
        public void SetName_ValidName_SetsName()
        {
            // Arrange
            var scholarship = MockValidTypeAssistance();
